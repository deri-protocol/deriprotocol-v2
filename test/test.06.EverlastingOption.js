...
describe('DeriV2', function () {
    ...
    beforeEach(async function() {
        ...
        usdt = await (await ethers.getContractFactory('TERC20')).deploy('Test BUSD', 'BUSD', 18)
        pricing = await (await ethers.getContractFactory('LinearPricing')).deploy()
        // pricing = await (await ethers.getContractFactory('ExponentialPricing')).deploy()
    ...
    async function getStates() {
        ...
        return {
            ...
            symbol0: {
                ...
                optionValue: symbol0.optionValue,
            ...
            symbol1: {
                ...
                optionValue: symbol1.optionValue,
            ...
            symbol2: {
                ...
                optionValue: symbol2.optionValue,
